...
class TripCard extends StatelessWidget {
  ...
  const TripCard({Key? key, required this.trip, this.onDeleted}) : super(key: key);
    ...
    ScaffoldMessenger.of(context)
      ...
      ..showSnackBar(
        SnackBar(
          ...
          dismissDirection: isDeleting ? DismissDirection.none : DismissDirection.horizontal,
        ),
      );
            ...
            Positioned.fill(
              child: trip.imageUrl.isNotEmpty
                ...
                child: FadeInImage.memoryNetwork(
                  placeholder: kTransparentImage, // wymaga pakietu transparent_image
                  image: trip.imageUrl,
                  fit: BoxFit.cover,
