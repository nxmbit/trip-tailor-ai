...
import 'package:frontend/presentation/common/widgets/password_tab.dart';
import 'package:frontend/presentation/common/widgets/profile_image_tab.dart';
import 'package:frontend/presentation/common/widgets/username_tab.dart';
import 'package:frontend/presentation/state/providers/user_provider.dart';
import 'package:provider/provider.dart';
import '../../state/profile_management_state.dart';

class MobileProfileManagementScreen extends StatelessWidget {
  const MobileProfileManagementScreen({super.key});
